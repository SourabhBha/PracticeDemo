...
//	}
	...
	override var placeholder:String? {
		didSet {
            ...
            title.textColor = Constants.AppColor.lightGrayColor//UIColor.init(hex: "A7A7AB")
			title.sizeToFit()
		}
	}
...
@IBInspectable var hintYPadding:CGFloat = 3.0
...
@IBInspectable var titleYPadding:CGFloat = 3.0 {
    ...
    @IBInspectable var titleTextColour:UIColor = Constants.AppColor.lightGrayColor ?? UIColor.lightGray/*UIColor.init(hex: "A7A7AB")*/ {
    didSet {
        if !isFirstResponder {
...
@IBInspectable var titleActiveTextColour:UIColor! = Constants.AppColor.lightGrayColor/*UIColor.init(hex: "A7A7AB")*/{
    didSet {
        if isFirstResponder {
...
//            r = UIEdgeInsetsInsetRect(r, UIEdgeInsets(top: top, left: 0.0, bottom: 0.0, right: 0.0))
	...
	fileprivate func setup() {
		...
		titleActiveTextColour = Constants.AppColor.lightGrayColor//UIColor.init(hex: "FFFFFF")
		// Set up title label
		title.alpha = 0.0
		title.font = titleFont
		title.textColor = titleTextColour
